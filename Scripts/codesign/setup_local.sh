#!/usr/bin/env bash
# Setup local self-signed certificate for Hinto development
# This prevents accessibility permission reset on every rebuild
#
# Creates a local self-signed certificate for code signing
#
...
echo "You can now build Hinto without accessibility permission resets."
echo ""
